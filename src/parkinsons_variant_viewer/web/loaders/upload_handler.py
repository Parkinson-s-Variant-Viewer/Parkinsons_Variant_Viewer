...
def handle_uploaded_file(file_path):
    ...
    for var in variants:
        try:
            ...
            hgvs_id = hgvs_obj.get_hgvs()  # will call fetch() internally
            if not hgvs_id:
            ...
            logger.error(f"Error processing Patient {var['patient_id']}, Variant {var['variant_number']}: {e}",
                         exc_info=True)
